...
public class GitLog {
	...
	public void init(){
		...
		this.proPath=this.proPath.replace("/", "\\\\");
		this.sinceDate=localResource.getString("gitlog.sinceDate");
		this.untilDate=localResource.getString("gitlog.untilDate");
		this.author=localResource.getString("gitlog.author");
	}
